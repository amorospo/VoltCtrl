...
<form method="post" action="formvar.php">
  TUTTI I VALORI SONO OBBLIGATORI:<br><br>
  ...
  <input type="number" name="smtp_P" size="60" value="<?php echo $smtp_P;?>"><br><br>
  ...
  9 Inserisci il valore in Volt sotto il quale inviare un messaggio di allarme blackout (default: 1)<br>
  <input type="number" name="BlackOut" size="60" value="<?php echo $BlackOut;?>"><br><br>
  10 Inserisci il valore in Volt sotto il quale inviare un messaggio di allarme tensione bassa (default: 215)<br>
  <input type="number" name="LowV" size="60" value="<?php echo $LowV;?>"><br><br>
  11 Inserisci il valore in Volt sotto il quale inviare un messaggio di allarme tensione alta (default: 245)<br>
  <input type="number" name="HiV" size="60" value="<?php echo $HiV;?>"><br><br>
  12 Inserisci il valore in secondi del tempo di refresh dello script (default: 30)<br>
  <input type="number" name="lapse" size="60" value="<?php echo $lapse;?>"><br><br>
